...
const INITIAL_STATE = {
  ...
  input: "",
  error: "",
  gameState: "start", // 'start', 'playing', 'won'
};
  ...
  return (
    <main className="relative flex items-center justify-center h-screen bg-stone-900 text-stone-300 font-serif overflow-hidden">
      ...
      <motion.div 
        ...
        animate={{ scale: [1, 1.02, 1], transition: { duration: 40, repeat: Infinity, ease: "easeInOut" } }}
      />
...
const StartScreen = ({ onStart }) => (
  ...
  >
    ...
    <h1 className="text-4xl md:text-6xl font-bold mb-4 text-amber-400" style={{ fontFamily: "'Cinzel', serif" }}>
      The Da Vinci Clue
    </h1>
    <p className="max-w-md mb-8 text-stone-300 text-lg">
      A trail of cryptic symbols has been left for you. Decode the clues, solve the mystery, and find the truth before it is lost to the ages.
    </p>
    <motion.button
      onClick={onStart}
...
const FinalRevealScreen = ({ onReset }) => (
  <motion.div
    key="won"
  ...
  >
    ...
    >
      Beneath the silent stars and watchful eyes of history, the path concludes. You have followed the echoes of the Priory and proven worthy. The legacy is now yours to protect.
    </motion.p>
